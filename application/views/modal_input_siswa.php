  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo site_url('SiswaController/save'); ?>" method="post">
          <div class="form-group">
            <label for="nis">Nis:</label>
            <input type="text" class="form-control" name="nis" id="nis" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required>
          </div>
          <div class="form-group">
            <label for="kelas">Nama Siswa:</label>
            <input type="text" class="form-control" name="nama_siswa" id="nama_siswa" onkeypress="return event.charCode < 48 || event.charCode  > 57" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select name="agama_siswa" class="form-control">
              <option disabled selected value="">--Agama Siswa--</option>
