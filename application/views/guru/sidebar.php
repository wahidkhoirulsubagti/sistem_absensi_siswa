<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('guru/data_absensi'); ?>">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('guru/data_rekapitulasi'); ?>">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <marquee>
                        <font size="4" face="Times New Roman Bold"><b>Selamat Datang Di Sistem Informasi Absensi Siswa</b> <i><b>Harian</b></i> <b>Berbasis Website</b></font>
                    </marquee>
                    <!-- Topbar Navbar -->
